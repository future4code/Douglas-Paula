...
export default function TripDetails() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://us-central1-labenu-apis.cloudfunctions.net/labeX/douglas-rodrigues-banu/trip/${id}`,
        {
          headers: {
            auth: token,
          },
  ...
  const handleCandidates = (candidateId, approve) => {
    axios
      .put(
        `https://us-central1-labenu-apis.cloudfunctions.net/labeX/douglas-rodrigues-banu/trips/${id}/candidates/${candidateId}/decide`,
        { approve: approve },
        {
          headers: {
